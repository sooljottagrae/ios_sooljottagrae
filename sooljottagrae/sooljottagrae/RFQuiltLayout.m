...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if([self.delegate respondsToSelector:@selector(collectionView:layout:insetsForItemAtIndexPath:column:)]) {
        NSUInteger colum = self.direction == UICollectionViewScrollDirectionVertical ? frame.origin.x / self.blockPixels.width : frame.origin.y / self.blockPixels.height;
        insets = [[self delegate] collectionView:[self collectionView] layout:self insetsForItemAtIndexPath:indexPath column:colum];
    }
...
- (CGRect) frameForIndexPath:(NSIndexPath*)path {
    ...
    /*
    @"application for your academy";
    
    @"Dear Cho"
    @"I am a programer who wishes listen your class. I work for Naver and my job is making a mobile application. I am writing to request your approval."
    
    "I want to improve my english ability. Because I see many english webpage while working. almost IT technology and programing language are written by English.
    "And my friend working in Seattle advised me that if I speak good English, I can earn much money in USA "

    "But I have a weak mind and can't study it alone. So I expect your good teaching."
    
    "I will appreciate your teaching on sunday."
    "Gyeongmo Jo"
    */
